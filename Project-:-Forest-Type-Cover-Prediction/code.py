...
# create subset with first 10 continuous cols
...
# plot the heatmap 
sns.heatmap(data_corr,linecolor='green',annot=True)

# list the corr pairs
correlation = data_corr.unstack().sort_values(kind='quicksort')

# select the vlaues having corr valus >upper_threshold & <lower_threshold & !=1 
corr_var_list = correlation[((correlation.values>upper_threshold) | (correlation.values < lower_threshold)) & (correlation.values != 1)]

print('corr_var_list :',corr_var_list)
